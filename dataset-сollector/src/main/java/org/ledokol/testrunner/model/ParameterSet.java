...
public class ParameterSet {
    ...
    public ParameterSet(int vuser, int pacing, int requestSize, int steps, boolean isDone, boolean redone) {
        this.vuser = vuser;
        this.pacing = pacing;
        this.requestSize = requestSize;
        this.steps = steps;
    ...
    public ParameterSet(int vuser, int pacing, int requestSize, int steps, boolean isDone, boolean redone,  Date startDate, Date endDate) {
        this.vuser = vuser;
        this.pacing = pacing;
        this.requestSize = requestSize;
        this.steps = steps;
