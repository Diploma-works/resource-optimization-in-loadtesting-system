...
public class TestSet {
    ...
    public TestSet(ParameterSet parameterSet){
    ...
    public TestSet(ObjectId id, int vuser, int pacing, int requestSize, int steps,
    ...
    public TestSet(int vuser, int pacing, int requestSize, int steps, boolean isDone, boolean redone) {
        this.vuser = vuser;
        this.pacing = pacing;
        this.requestSize = requestSize;
        this.steps = steps;
    ...
    public TestSet(int vuser, int pacing, int requestSize, int steps, boolean isDone, boolean redone, Date startDate, Date endDate) {
        this.vuser = vuser;
        this.pacing = pacing;
        this.requestSize = requestSize;
        this.steps = steps;
